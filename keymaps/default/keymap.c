...
const uint16_t PROGMEM dip_switch_map[NUM_DIP_SWITCHES][NUM_DIP_STATES] = {
    DIP_SWITCH_OFF_ON(KC_NO, RGB_TOG)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_84(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,    _______,   _______, _______, KC_NUM,
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_RMOD,  _______, _______, _______
    )
};
/*
